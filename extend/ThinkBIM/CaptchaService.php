...
class CaptchaService extends Service
{
    ...
    public function initialize(array $config = [])
    {
        ...
        // 设置字体文件路径
        $this->fontfile = __DIR__ . '/../../public/static/plugs/awesome/fonts/captcha.ttf';
        // $this->fontfile = root_path() . 'public/static/plugs/awesome/fonts/captcha.ttf';
        // print_r($this->fontfile);die;
        // 缓存验证码字符串
